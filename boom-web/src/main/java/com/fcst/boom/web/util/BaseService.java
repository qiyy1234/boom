...
import com.fcst.boom.domain.BaseEntity;
...
public abstract class BaseService {
	...
	public static String dataScopeFilter(User user, String officeAlias, String userAlias) {
		...
		System.out.println("------- start ----dataScopeFilter --- 数据范围果壳滤 -- ------"+officeAlias);
		System.out.println("------- start ----dataScopeFilter --- 数据范围果壳滤 -- ------"+userAlias);
	...
	public static void dataScopeFilter(BaseEntity<?> entity, String sqlMapKey, String officeWheres, String userWheres) {
		System.out.println("------- start222 ----dataScopeFilter --- 数据范围果壳滤 -- ------");
...
//		System.out.println("dataScopeFilter: " + sqlString.toString());
		...
		System.out.println("------- end 222----dataScopeFilter --- 数据范围果壳滤 -- ------");
	}
